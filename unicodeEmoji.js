const emojiList = {
    puzzle: { icon: '🧩', unicode: '\uD83E\uDDF9', description: 'Widget to grid' },
    satellite: { icon: '📡', unicode: '\uD83D\uDCF1', description: 'Serviceworker' },
    cross: { icon: '❌', unicode: '\u274C', description: 'Delete widget' },
    arrowDown: { icon: '⬇', unicode: '\u2B07', description: 'Increase height' },
    arrowRight: { icon: '➡', unicode: '\u27A1', description: 'Increase width' },
    arrowUp: { icon: '⬆', unicode: '\u2B06', description: 'Decrease height' },
